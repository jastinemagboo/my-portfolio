          ...
          <div class="space-y-4 p-5">
            ...
            <div class="flex flex-wrap gap-2 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center gap-1 shadow-lg rounded-full border border-gray-400 px-4 py-2 text-xs font-semibold text-gray-700 transition hover:bg-gray-50"
              >
                <Icon
